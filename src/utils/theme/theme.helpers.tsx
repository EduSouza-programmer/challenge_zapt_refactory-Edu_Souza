...
export const icons = {
  ...
  ArrowBackIos: (props: SVGIconProps) => (
    <ArrowBackIos role="img" title="ArrowBackIos" {...props} />
  ),
  ArrowForwardIos: (props: SVGIconProps) => (
    <ArrowForwardIos role="img" title="ArrowBackIos" {...props} />
  ),
} as const;
