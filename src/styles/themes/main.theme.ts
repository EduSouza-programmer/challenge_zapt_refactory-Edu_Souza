...
export default {
  ...
  typography: {
    fontFamily: `"Inter", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Oxygen", "Ubuntu", "Cantarell", "Open Sans", "Helvetica Neue", "sans-serif"`,
    fontWeight: {
      light: 300,
      medium: 400,
      semiBold: 500,
  ...
  palette: {
    page: {
      primary: {
        ...
        dark: polished.darken(0.1, "#334BC8"),
      },
      secondary: {
        main: "#FF5B58",
      },
    ...
    button: {
      ...
      primary: {
        main: "#334BC8",
        light: polished.lighten(0.1, "#334BC8"),
        dark: polished.darken(0.1, "#334BC8"),
      },
      secondary: {
        main: "#FF5F5F",
        light: polished.lighten(0.1, "#FF5F5F"),
        dark: polished.darken(0.1, "#FF5F5F"),
      },
      white: {
        main: "#fff",
        ligth: "",
